...
ALTER TABLE NATION_TBL DROP PRIMARY KEY;
ALTER TABLE EVENT_TBL DROP PRIMARY KEY;
ALTER TABLE PLAYER_TBL DROP PRIMARY KEY;
ALTER TABLE SCHEDULE_TBL DROP PRIMARY KEY;
...
ALTER TABLE PLAYER_TBL DROP CONSTRAINT FK_PLAYER_NATION;
ALTER TABLE PLAYER_TBL DROP CONSTRAINT FK_PLAYER_EVENT;
ALTER TABLE SCHEDULE_TBL DROP CONSTRAINT FK_SCHEDULE_NATION;
ALTER TABLE SCHEDULE_TBL DROP CONSTRAINT FK_SCHEDULE_EVENT;


-- 외래키 추가하기
ALTER TABLE PLAYER_TBL ADD CONSTRAINT FK_PLAYER_NATION FOREIGN KEY(N_CODE) REFERENCES NATION_TBL(N_CODE);
ALTER TABLE PLAYER_TBL ADD CONSTRAINT FK_PLAYER_EVENT FOREIGN KEY(E_CODE) REFERENCES EVENT_TBL(E_CODE);
ALTER TABLE SCHEDULE_TBL ADD CONSTRAINT FK_SCHEDULE_NATION FOREIGN KEY(N_CODE) REFERENCES NATION_TBL(N_CODE) ON DELETE SET NULL;  -- ON DELETE CASCADE도 가능하다.;
ALTER TABLE SCHEDULE_TBL ADD CONSTRAINT FK_SCHEDULE_EVENT FOREIGN KEY(E_CODE) REFERENCES EVENT_TBL(E_CODE) ON DELETE SET NULL;  -- ON DELETE CASCADE도 가능하다.;
