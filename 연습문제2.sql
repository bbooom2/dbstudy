...
INSERT INTO BOOK_TBL (BOOK_ID, BOOK_NAME, PUBLISHER, PRICE) VALUES(BOOK_SEQ.NEXTVAL, '축구의 역사', '굿 스포츠', 7000);    
...
GROUP BY C.CUSTOMER_ID, C.CUSTOMER_NAME; -- 같은 이름이 여러명 될 수 있으니까 CUSTOMER_ID도 GROUP BY 해주는 것 
